...
<div id="main">
<h2>Login Form</h2>
<form action="Campaign- Organizer-page.php" method="post">
<label>Name :</label>
...
$query = mysql_query("select * from CampaignOrganizer where password='$password' AND name='$username'", $connection);
$rows = mysql_num_rows($query);
if ($rows == 1) {
$_SESSION['login_user']=$username; // Initializing Session
header("location: Campaign- Organizer-page.php"); // Redirecting To Other Page
} else {
$error = "Username or Password is invalid";
}
