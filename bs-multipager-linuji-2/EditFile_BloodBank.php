...
$new_name = $_POST['BB_Name'];
$new_address = $_POST['BB_address'];
$new_phone = $_POST['BB_phone'];
$new_email = $_POST['BB_email'];
$new_password = $_POST['BB_password'];

//Write the query :
$query = "UPDATE `BloodBank` SET `email`='$new_email ',`password`='$new_password',`phone`='$new_phone ',`address`='$new_address',`name`='$new_name' WHERE `email` = '$new_email'";
...
function validateForm() {
    var name = document.forms["edit_BB"]["BB_Name"].value;
    var password = document.forms["edit_BB"]["BB_password"].value;
    var Address = document.forms["edit_BB"]["BB_address"].value;
    var email = document.forms["edit_BB"]["BB_email"].value;
    var phone = document.forms["edit_BB"]["BB_phone"].value;
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="txt-block">
									...
									<h1 class="head-line"> Blood Bank </h1>
...
<form name="edit_BB" onsubmit="return validateForm()" method="POST" action="EditFile_BloodBank.php">
           ...
           <!--Address -->
            ...
            <label style="padding-top: 25px">Address :</label>
             <input type="text" name="BB_address"/>
            <!--Phone Number -->
            <br/>
            <label style="padding-top: 25px">Phone Number :</label>
            <input type="text" name="BB_phone">
            <br/>
           </div>
