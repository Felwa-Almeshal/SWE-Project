...
$sql = "INSERT INTO `Donor` (`name`, `email`, `password`, `address`, `phone`, `D.O.B`)  VALUES ('$username', '$email', '$password','$address','$phone',$birthDate )";
...
<h2>Signup Form of Donor</h2>

<form action="donorSingup.php" name="myForm" method = "POST" style="border:1px solid #ccc" onsubmit="return validateForm()">
  <div class="container">
