...
$sql = "INSERT INTO `CampaignOrganizer` (`email`, `password`, `phone`, `address`,`name`) VALUES ('$email', '$password','$phone', '$address','$username')";
...
<h2>Signup Form Of Campigan Organaizer </h2>

<form action="CampiganSingup.php"  method = "POST" style="border:1px solid #ccc">
  <div class="container">
