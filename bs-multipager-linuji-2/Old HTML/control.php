...
<body>
 ...
 <div class="navbar navbar-inverse set-radius-zero" >
        <div class="container">
            ...
            <div class="right-div">
<strong>Support : </strong>  info@donation.com
            </div>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="blank.html">Sign in</a></li>
...
<h1>  Choose the type of user </h1>

<div >
 <a href="donor-login.php">Donor</a>
</div>
<div >
 <a href="blood-bank-login.php">Blood Bank</a>
</div>
<div >
 <a href="Campaign- Organizer-login.php">Blood Donation Campaign Organizer</a>
</div>
