...
$eventDetails = $_POST['annDetails'];
$location = $_POST['location'];
$id = $_GET['id'];

$sql = "INSERT INTO `BankEvent` (`title`, `startDate`, `endDate`, `eventDetails`, `location`, `id`) VALUES ('$title','$startDate','$endDate','$annDetails','$location','$id')";
...
<strong>Support : </strong>  sw2Donation@gmail.com
  ...
  <a class="right carousel-control" href="#carousel-div" data-slide="next">
    ...
    <!-- AddEventCampaignOrganizer contunt --!>
    <br>
    <h1> Blood donation campaign organizer </h1>
  <form action="AddEventCampaign.php" name="myForm" method = "POST" style="border:0px solid #ccc" onsubmit="return validateForm()">  
    <br> <br> <br>
...
<br> <br> <br> 
  ...
  <label> Start date </label>  <br>
   ...
   <div class="EndDate"> <label> End date </label> </div>
...
<br> <br> 
  ...
  <label> Event details </label> <br>
   <textarea rows="4" name="Eventdetails" cols="50">  Event details </textarea>  
