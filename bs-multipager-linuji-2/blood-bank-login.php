...
<div id="main">
<h2>Login Form</h2>
<form action="blood-bank-page.php" method="post">
<label>Name :</label>
...
$query = mysql_query("select * from BloodBank where password='$password' AND name='$username'", $connection);
$rows = mysql_num_rows($query);
if ($rows == 1) {
$_SESSION['login_user']=$username; // Initializing Session
header("location: blood-bank-page.php"); // Redirecting To Other Page
} else {
$error = "Username or Password is invalid";
}
