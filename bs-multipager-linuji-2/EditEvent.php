...
$sql = "INSERT INTO `BankAnnouncement` (`title`, `startDate`, `endDate`, `annDetails`) VALUES ('$title','$startDate','$endDate','$annDetails')";
$result = mysql_query($sql);
if($result){
	echo "Event Successfully Eidted";
}else {
	die(mysql_error());
}
...
<strong>Support : </strong>  sw2Donation@gmail.com
  ...
  <a class="right carousel-control" href="#carousel-div" data-slide="next">
    ...
    <!-- EditEventBloodB contunt --!>
      <!-- ****************************** --!>
      
    <br>
    <h1> Blood Bank </h1>
  <form action="EditEvent.php" name="myForm" method = "POST" style="border:0px solid #ccc" onsubmit="return validateForm()">  
    <br> <br> <br>
...
<br> <br> <br> 
  ...
  <label> Start date </label>  <br>
    <input type="text" name="startDate" data-icon="" value="">  
    <!--    <label><b> DOB </b></label>
    <input type="text" placeholder="Enter Date" name="date" required> --!>
   <div class="EndDate"> <label> End date </label>  <br>
    <input type="text" name="endDate" data-icon="" value="">  </div>
    
    
<br> <br> 
     
  <label> Event details </label> <br>
   <textarea rows="4" name="annDetails" cols="50">  Event details </textarea>  
    
    <br> <br>
      <button type="submit" name ="submit" class="EditEvent"> Edit Event </button>
