...
if(isset($_SESSION['edit'])){//start if valid user 
$new_name = $_POST['CO_Name'];
$new_address = $_POST['CO_address'];
$new_phone = $_POST['CO_phone'];
$new_email = $_POST['CO_email'];
$new_password = $_POST['CO_password'];

//Write the query :
$query = "UPDATE `CampaignOrganizer` SET `email`='$new_email',`password`='$new_password',`phone`='$new_phone',`address`='$new_address',`name`='$new_name' WHERE `email` = '$new_email'";
...
function validateForm() {
    var name = document.forms["edit_CO"]["CO_Name"].value;
    var password = document.forms["edit_CO"]["CO_password"].value;
    var Address = document.forms["edit_CO"]["CO_address"].value;
    var email = document.forms["edit_CO"]["CO_email"].value;
    var phone = document.forms["edit_CO"]["CO_phone"].value;
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="txt-block">
						...
						<h1 class="head-line"> Campaign Organizer </h1>
...
<form name="edit_CO" onsubmit="return validateForm()" method="POST" action="EditFile_CampaignOrganizer.php">
           ...
           <!--Address -->
            ...
            <label style="padding-top: 25px">Address :</label>
             <input type="text" name="CO_address"/>
            <!--Phone Number -->
            <br/>
